...
export default function AboutSection() {
  return (
    <section className="bg-white py-16 px-4">
      <div className="max-w-7xl mx-auto text-center md:text-left grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="space-y-6">
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            Discover a world of quality products tailored for your everyday needs.
            From fashion to electronics, we bring you the best at unbeatable prices.
      ...
      {/* Additional Images Section (One Image per Line) */}
      ...
      <div className="max-w-7xl mx-auto mt-16 text-center">
        ...
        <div className="relative w-full h-0 pb-[56.25%]">
          <iframe
            className="absolute top-36 left-96 mr-80 min-w-96 h-64 rounded-lg shadow-lg"
            src="/Video card.png"
            title="Our Story"
            frameBorder="0"
      ...
      {/* Bottom Images Section (One Image per Line) */}
      <div className="max-w-7xl mx-auto mt-16 text-center">
        <div className="mb-8">
          <Image
            src="ye.jpg"
